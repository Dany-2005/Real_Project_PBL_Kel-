            ...
            <nav class="mt-4 px-4 space-y-1 pb-4">
                ...
                @if(auth()->user()->role === 'pemilik')
                    ...
                    <a href="{{ route('pelanggan.index') }}"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition
                       {{ request()->routeIs('pelanggan.*') ? 'bg-[#2d6a4f] text-white' : 'text-gray-700 hover:bg-green-50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('produk.index') }}"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition
                       {{ request()->routeIs('produk.*') ? 'bg-[#2d6a4f] text-white' : 'text-gray-700 hover:bg-green-50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('kategori.index') }}"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition
                       {{ request()->routeIs('kategori.*') ? 'bg-[#2d6a4f] text-white' : 'text-gray-700 hover:bg-green-50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('diskon.index') }}"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition
                       {{ request()->routeIs('diskon.*') ? 'bg-[#2d6a4f] text-white' : 'text-gray-700 hover:bg-green-50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="pt-2">
                        ...
                        <div x-show="openOperasional" x-cloak x-transition class="ml-4 mt-1 space-y-1 border-l-2 border-gray-100 pl-3">
                            <a href="{{ route('pembelian.index') }}"
                               ...
                               {{ request()->routeIs('pembelian.*') ? 'text-[#2d6a4f] bg-green-50' : 'text-gray-500 hover:text-[#2d6a4f] hover:bg-green-50' }}">
                            ...
                            <a href="{{ route('pengaturan.kasir') }}"
                               class="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-bold transition
                               {{ request()->is('pengaturan/kasir*') ? 'text-[#2d6a4f] bg-green-50' : 'text-gray-500 hover:text-[#2d6a4f] hover:bg-green-50' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="pt-2">
                        <button @click="openPengaturan = !openPengaturan"
                                class="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl font-bold text-sm transition
                                {{ request()->routeIs('landing.*') || request()->is('pengaturan/pemilik') ? 'bg-[#2d6a4f] text-white' : 'text-gray-700 hover:bg-green-50' }}">
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-show="openPengaturan" x-cloak x-transition class="ml-4 mt-1 space-y-1 border-l-2 border-gray-100 pl-3">
                            <a href="{{ route('landing.index') }}"
                               class="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-bold transition
                               {{ request()->routeIs('landing.*') ? 'text-[#2d6a4f] bg-green-50' : 'text-gray-500 hover:text-[#2d6a4f] hover:bg-green-50' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('pengaturan.pemilik') }}"
                               class="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-bold transition
                               {{ request()->is('pengaturan/pemilik') ? 'text-[#2d6a4f] bg-green-50' : 'text-gray-500 hover:text-[#2d6a4f] hover:bg-green-50' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                </svg>
                ...
                @if(auth()->user()->role === 'kasir')
                    ...
                    <a href="{{ route('transaksi.index') }}"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition
                       {{ request()->routeIs('transaksi.*') ? 'bg-[#2d6a4f] text-white' : 'text-gray-700 hover:bg-green-50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
