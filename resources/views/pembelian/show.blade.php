                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-gray-800 font-medium">{{ \Carbon\Carbon::parse($pembelian->tanggal)->format('d/m/Y') }}</span>
                        </div>
                        @if($pembelian->keterangan)
                        <div class="pt-2 border-t border-gray-100">
                            <span class="text-gray-500 block mb-1">Keterangan</span>
                            <span class="text-gray-700 text-xs italic">"{{ $pembelian->keterangan }}"</span>
                        </div>
                        @endif
                    </div>
                </div>
